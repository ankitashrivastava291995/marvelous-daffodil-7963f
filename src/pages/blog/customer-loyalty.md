...
seo:
  ...
  extra:
    ...
    - name: 'twitter:image'
      ...
      relativeUrl: true
template: post
thumb_image: images/APP_DEVELOPMENT.png
title: TOP TRENDING TECHNOLOGY IN 2021
date: '2021-05-19'
excerpt: >-
  Top Trending technology in 2021 Trend 1: Internet of Behaviors As demonstrated
  by the COVID-19 protocol monitoring example, the IoB is about using data to
  change behaviors. With an increase in technologies that gather the “digital
  dust” of daily life — data that spans the digital and physical worlds — that
  information can be […]
---
